...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link" href="Nuestro_Servicio/">Nuestro Servicio</a>
    ...
    <section class="image-section">
        <!-- Imagen -->
        <img src="img/imglogin.png" alt="Descripción de la imagen" class="img-fluid d-block mx-auto w-25 bg-black mt-3 img-fluid" style="max-width: 10%;">
    </section>
        ...
        <div class="row text-center g-1">
            ...
            <div class="col-3 mb-3">
                <a href="https://www.facebook.com" target="_blank">
                    <img src="img/facebook.png" class="img-fluid rrss bg-white" alt="Facebook">
                </a>
            </div>
            <div class="col-3 mb-3">
                <a href="https://www.instagram.com" target="_blank">
                    <img src="img/instagram.png" class="img-fluid rrss bg-white" alt="Instagram">
                </a>
            </div>
            <div class="col-3 mb-3">
                <a href="https://www.twitter.com" target="_blank">
                    <img src="img/logotipo-de-twitter-sobre-fondo-negro.png" class="img-fluid rrss bg-white" alt="Twitter">
                </a>
            </div>
            <div class="col-3 mb-3">
                <a href="https://www.tiktok.com" target="_blank">
                    <img src="img/tik-tok.png" class="img-fluid rrss bg-white" alt="TikTok">
                </a>
            </div>
            <!-- Segunda fila de 4 elementos -->
            <div class="col-3 mb-3">
                <a href="https://www.youtube.com" target="_blank">
                    <img src="img/youtube.png" class="img-fluid rrss bg-white" alt="YouTube">
                </a>
            </div>
            <div class="col-3 mb-3">
                <a href="https://www.telegram.com" target="_blank">
                    <img src="img/telegrama.png" class="img-fluid rrss bg-white" alt="Telegram">
                </a>
            </div>
            <div class="col-3 mb-3">
                <a href="https://www.whatsapp.com" target="_blank">
                    <img src="img/whatsapp.png" class="img-fluid rrss bg-white" alt="WhatsApp">
                </a>
            </div>
            <div class="col-3 mb-3">
                <a href="https://www.linkedin.com" target="_blank">
                    <img src="img/linkedin.png" class="img-fluid rrss bg-white" alt="LinkedIn">
                </a>
            </div>
        </div>
    </div>
